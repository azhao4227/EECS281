...
void testUpdatePriorities() {
    ...
    assert(*eecsPQ.top() == 2000);
    eecsPQ.pop();
    assert(*eecsPQ.top() == 600);
    std::cout << *eecsPQ.top() << std::endl;
    eecsPQ.pop();
    assert(*eecsPQ.top() == 500);
    std::cout << *eecsPQ.top() << std::endl;
...
void testPairing() {
...

    {
        ...
        PairingPQ<int>::Node* n = pairing4.addNode(2);
        pairing4.addNode(5);
        pairing4.addNode(2);
        PairingPQ<int>::Node* x = pairing4.addNode(7);
        pairing4.addNode(8);
        pairing4.push(20);
        pairing4.push(80);
        pairing4.addNode(2);
        ...
        std::cout << pairing4.size() << std::endl;
        pairing4.updateElt(n, 100);
        std::cout << pairing4.top() << std::endl;
        pairing4.pop();
        pairing4.updateElt(x, 90);
        std::cout << pairing4.top() << std::endl;
        std::cout << pairing4.size() << std::endl;
